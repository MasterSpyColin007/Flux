...
Authenticated users can manage posts from the browser:

- `GET /posts` lists posts
- `GET /posts/create` creates a post
- `GET /posts/{id}` views a post
- `GET /posts/{id}/edit` updates a post
- `GET /posts/{id}/delete` confirms deletion
